...
class Topic extends Model {
    ...
    public  $presenter = '\App\good\Presenters\TopicPresenter';
    ...
    public function getTopicsSearchWithFilter($filter, $limit = 20)
    {
        return $this->applyFilter($filter)
                    ->with('user', 'node', 'lastReplyUser');
    }

    public function getNodeTopicsWithFilter($filter, $node_id)
    {
