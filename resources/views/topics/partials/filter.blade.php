<ul class="pull-right list-inline remove-margin-bottom topic-filter">
    ...
    <li>
        <a {!! App::make('\App\Topic')->present()->topicFilter('recent') !!}>
    ...
    <li>
        <a {!! App::make('\App\Topic')->present()->topicFilter('excellent') !!}>
    ...
    <li>
        <a {!! App::make('\App\Topic')->present()->topicFilter('vote') !!}>
    ...
    <li>
        <a {!! App::make('\App\Topic')->present()->topicFilter('noreply') !!}>
