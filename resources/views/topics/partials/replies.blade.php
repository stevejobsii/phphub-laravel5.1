   ...
   <li class="list-group-item media"
    ...
    <div class="avatar pull-left">
      <a href="{!! route('users.show', [$reply->user_id]) !!}">
        <img class="media-object img-thumbnail avatar" alt="{!! $reply->user->name !!}" src="{!! $reply->user->present()->avatar_30 !!}"  style="width:48px;height:48px;"/>
      </a>
    </div>
    ...
    <div class="infos">
      ...
      <div class="media-heading meta">
        ...
        <span class="operate pull-right">
          ...
          @if (Auth::user() && (Auth::user()->can("manage_topics") || Auth::user()->id == $reply->user_id) )
